		...
		<div class="banner_x center">
			...
			<div class="search fr">
				<form action="SearchServlet" method="post">
					<div class="text fl">
						<input type="text" class="shuru" id="sousuo" placeholder="javaweb从入门的精通&nbsp">
					</div>
					<div class="submit fl">
...
<!-- self_info -->
	<div class="grzxbj">
		...
		%>
			...
			<div class="subgrzl ml40"><span>昵称</span><span><%=name%></span></div>
			<div class="subgrzl ml40"><span>手机号</span><span><%=tel%></span></div>
