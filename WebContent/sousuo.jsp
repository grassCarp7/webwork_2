		...
		<div class="banner_x center">
			...
			<div class="search fr">
				<form action="SearchServlet" method="post">
					<div class="text fl">
						<input type="text" class="shuru"  placeholder="javaweb从入门到精通">
					</div>
					<div class="submit fl">
...
<!-- end banner_x -->
   ...
   <%
	   ...
	   List<Stock> list=(List<Stock>)request.getAttribute("list_search");
   ...
   %>
	    ...
	    <div class="mingxing fl mb20" style="border:2px solid #fff;width:230px;cursor:pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
	     ...
	     <div class="pinpai"><a  href="DetailServlet?store_id=<%=list.get(i).getBusinessID() %>&goods_id=<%=list.get(i).getGoodsID()%>" target="_blank"><span><%=list.get(i).getGoodsName()%></span></a></div>
	     <div class="youhui"><span><%=list.get(i).getIntroduction()%></span></div>
