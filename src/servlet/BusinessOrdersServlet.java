...
import database.*;
/**
 * Servlet implementation class BusinessOrdersServlet
 */
@WebServlet("/BusinessOrdersServlet")
public class BusinessOrdersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusinessOrdersServlet() {
        super();
