...
import database.*;
/**
 * Servlet implementation class BusinessStockServlet
 */
@WebServlet("/BusinessStockServlet")
public class BusinessStockServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BusinessStockServlet() {
        super();
